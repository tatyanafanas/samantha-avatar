...
# =========================
# HF MULTI-FALLBACK (FIX)
# =========================

def query_hf(messages):
    """
    Try multiple HF models instead of dying on first failure.
    """
    for model in HF_FALLBACK_MODELS:
        try:
            ...
            print(f"[HF FAIL] model={model} error={e}")
            continue

    return "[HF FAILED ALL MODELS]"
